function HUDMissionBriefing:init(hud, workspace)
	...
	logger("[HUDMissionBriefing: init] 1" .. "\n")
	...
	logger("[HUDMissionBriefing: init] 2" .. "\n")
	...
	if not self._singleplayer then
		...
		for i = 1, num_player_slots do
			...
			logger("[HUDMissionBriefing: init] My Iteration is: " .. tostring(i) .. "\n")
			logger("[HUDMissionBriefing: init] My Colour is: " .. tostring(color) .. "\n")
	...
	logger("[HUDMissionBriefing: init] 3.2" .. "\n")
	local padding_y = 60
	...
	logger("[HUDMissionBriefing: init] 3.3" .. "\n")
	...
	logger("[HUDMissionBriefing: init] 3.6" .. "\n")
	...
	logger("[HUDMissionBriefing: init] 3.7" .. "\n")
	...
	logger("[HUDMissionBriefing: init] 4" .. "\n")
	...
	logger("[HUDMissionBriefing: init] 5" .. "\n")
	...
	for i = 1, 7 do
		logger("[HUDMissionBriefing: init] 5.1-" .. tostring(i) .. "\n")
		...
		logger("[HUDMissionBriefing: init] 5.2-" .. tostring(i) .. "\n")
		...
		logger("[HUDMissionBriefing: init] 5.3-" .. tostring(i) .. "\n")
		if i ~= 1 or not 0 then

			logger("[HUDMissionBriefing: init] 5.4-" .. tostring(i) .. "\n")
			day_text:set_left((self._job_schedule_panel:child("day_" .. tostring(i - 1)):right()))
			logger("[HUDMissionBriefing: init] 5.5-" .. tostring(i) .. "\n")
			...
			logger("[HUDMissionBriefing: init] 5.6-" .. tostring(i) .. "\n")
	...
	logger("[HUDMissionBriefing: init] 6" .. "\n")
	...
	logger("[HUDMissionBriefing: init] 7" .. "\n")
	...
	logger("[HUDMissionBriefing: init] 8" .. "\n")
	...
	logger("[HUDMissionBriefing: init] 9" .. "\n")
	...
	logger("[HUDMissionBriefing: init] 10" .. "\n")
	...
	logger("[HUDMissionBriefing: init] 11" .. "\n")
