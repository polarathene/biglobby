...
function HUDManager:add_weapon(data)
	if not self._teammate_panels[HUDManager.PLAYER_PANEL] then
		log("[HUDManager :add_weapon] teammate_panels[HUDManager.PLAYER_PANEL] is nil, HUDManager.PLAYER_PANEL = " .. tostring(HUDManager.PLAYER_PANEL))
		return
	end
	if not self._teammate_panels[HUDManager.PLAYER_PANEL]:panel() then
		log("[HUDManager :add_weapon] teammate_panels[HUDManager.PLAYER_PANEL]:panel() is nil, HUDManager.PLAYER_PANEL = " .. tostring(HUDManager.PLAYER_PANEL))
		return
	end
...
function HUDManager:add_teammate_panel(character_name, player_name, ai, peer_id)
	...
	for i, data in ipairs(self._hud.teammate_panels_data) do
		log("[HUDManager:add_teammate_panel] i: " .. tostring(i))
		if not data.taken then
			log("[HUDManager:add_teammate_panel] not taken. " .. tostring(i))
			...
			data.taken = true
			log("[HUDManager:add_teammate_panel] returning: " .. tostring(i))
			return i
		end
	end
end
